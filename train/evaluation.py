...
def evaluate_vs_rule_based(model, device: str, num_games: int = 100, seed: int = None) -> Dict[str, float]:
    """
    ...
    for game_idx in range(num_games):
        ...
        game_result = _play_single_game(
            env, model, rule_ai, device, model_is_player0
        )
